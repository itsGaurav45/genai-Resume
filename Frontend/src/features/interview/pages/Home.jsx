...
const Home = () => {
  ...
  const handleGenerateReport = async () => {
    ...
    console.log(
      "- Self description:",
      selfDescription.substring(0, 50) + "...",
    );

    // Validation: Either resume or self-description required
          ...
          <div className="panel panel--right">
            ...
            <div className="upload-section">
              ...
              >
                ...
                {selectedFileName ? (
                  <div>
                    <p className="dropzone__title">✓ File Selected</p>
                    <p className="dropzone__subtitle">{selectedFileName}</p>
                    <button
                      type="button"
